...
func (lc *LeaseContract) Equal(other *LeaseContract) bool {
	return lc.Id == other.Id && lc.From.Equal(other.From) && lc.To.Equal(other.To) && lc.Owner.Equal(&other.Owner) && lc.Tenant.Equal(&other.Tenant) && lc.Apartment.Equal(&other.Apartment)
}
